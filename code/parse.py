...
def parse_args():
    ...
    parser.add_argument('--keep_prob', type=float, default=0.6,
                        help="1 - dropuot ratio")
    parser.add_argument('--a_hat_folds', type=int, default=100,
    ...
    parser.add_argument('--multi_core', type=bool, default=False, help='whether we use multiprocessing or not in test')
